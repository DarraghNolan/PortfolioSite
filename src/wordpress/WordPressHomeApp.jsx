...
function normalizeRoomAssets(rawRooms, uploadsBaseUrl) {
  ...
  return rawRooms.map((room) => {
    ...
    return {
      ...
      textureNormal: resolveUploadsUrl(room.textureNormal, uploadsBaseUrl),
      textureOpacity: resolveUploadsUrl(room.textureOpacity, uploadsBaseUrl),
      textureRoughness: resolveUploadsUrl(room.textureRoughness, uploadsBaseUrl),
      textureMetalness: resolveUploadsUrl(room.textureMetalness, uploadsBaseUrl),
      textureEmissive: resolveUploadsUrl(room.textureEmissive, uploadsBaseUrl),
      emissiveColor: normalizeHex(room.emissiveColor, '#000000'),
      emissiveIntensity: clamp(room?.emissiveIntensity, 0, 5, 1),
      normalScale: clamp(room?.normalScale, 0, 5, 1),
      railPoints,
